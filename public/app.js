...
async function initMap() {
  ...
  document
    .getElementById("central-zone")
    .addEventListener("click", () =>
      zoomZones({ lat: -23.5489, lng: -46.6388 })
    );
  document
    .getElementById("north-zone")
    .addEventListener("click", () =>
      zoomZones({ lat: -23.4803, lng: -46.6708 })
    );
  document
    .getElementById("south-zone")
    .addEventListener("click", () =>
      zoomZones({ lat: -23.6542, lng: -46.6592 })
    );
  document
    .getElementById("east-zone")
    .addEventListener("click", () =>
      zoomZones({ lat: -23.5338, lng: -46.5033 })
    );
  document
    .getElementById("west-zone")
    .addEventListener("click", () =>
      zoomZones({ lat: -23.5719, lng: -46.7008 })
    );
  ...
  const busyDrivers = document.getElementById("busy-drivers");
  busyDrivers.innerHTML = countBusyDrivers;
  const readyDrivers = document.getElementById("ready-drivers");
